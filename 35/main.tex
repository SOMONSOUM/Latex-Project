...
% ប្រអប់
\tcolorboxenvironment{exercise}{colback=white!6!,colframe=red!75!black}
\tcolorboxenvironment{review}{colback=red!6!white,colframe=red!75!black}
\tcolorboxenvironment{general}{colback=red!6!white,colframe=blue!75!black}
\tcolorboxenvironment{formula}{colback=red!6!white,colframe=blue!75!black}
\setmainfont [Scale = 0.8333333334, Script=Khmer]{Khmer OS Battambang}
\begin{document}
\def\chaptername{\kml ជំពូក}
\renewcommand{\contentsname}{\kml មាតិកា} 
%----------------------------------------------------------------------------------------
%	TITLE PAGE
%----------------------------------------------------------------------------------------
...
\draw (current page.center) node [fill=ocre!30!white,fill opacity=0.6,text opacity=1,inner sep=1cm]{\Huge\centering\bfseries\sffamily\parbox[c][][t]{\paperwidth}{\centering \kml ដេរីវេនៃអនុគមន៍\\[15pt] % Book title
{\Large \today }\\[20pt] % Subtitle
{\huge \kml ហ៊ីង វុទ្ធី}}}; % Author name
\end{tikzpicture}
\vfill
\endgroup
...
\chapterimage{vothy.jpg} % Table of contents heading image
...
\chapterimage{vothy.jpg} % Chapter heading image
